<template>
  <div class="personal-container">
    ...
    <div class="personal-header gps-rlt">
      ...
      <div class="name">{{studentInfo.s_name}}</div>
      <div class="cell">{{studentInfo.s_uid}}</div>
    </div>
    <ul class="personal-list">
      ...
      <li class="gps-rlt" @click="choose">
        <i class="iconfont icon-already gps-abs gps-y" style="left:0.3rem;font-size: 0.38rem;color:red"></i>
        <span>选课记录</span>
        <i class="iconfont icon-next gfr"></i>
      </li>
...
<script>
  ...
  export default {
    ...
    methods: {
      account() {
        this.$router.push({ path: '/student/personal/account' })
      },
      own() {
        this.$router.push({ path: '/student/personal/own' })
      },
      other() {
        this.$router.push({ path: '/student/personal/finally' })
      },
      choose(){
        this.$router.push({ path: '/student/personal/already' })
      }
    }
  }
</script>
